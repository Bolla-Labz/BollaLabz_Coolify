...
-- Grant permissions
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO bollalabz;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO bollalabz;

-- Insert sample data for testing
INSERT INTO phone_contacts (phone_number, contact_name, contact_email) VALUES
    ('+1234567890', 'Test Contact', 'test@example.com')
ON CONFLICT (phone_number) DO NOTHING;

-- Verification queries
SELECT 'users' as table_name, COUNT(*) as row_count FROM users
UNION ALL
SELECT 'phone_contacts', COUNT(*) FROM phone_contacts
UNION ALL
SELECT 'conversation_messages', COUNT(*) FROM conversation_messages
UNION ALL
SELECT 'call_costs', COUNT(*) FROM call_costs
UNION ALL
...
UNION ALL
SELECT 'relationship_interactions', COUNT(*) FROM relationship_interactions
UNION ALL
